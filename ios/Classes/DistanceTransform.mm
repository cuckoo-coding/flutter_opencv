...
@implementation DistanceTransform
...
+ (void)process:(FlutterStandardTypedData *)data distanceType: (int) distanceType maskSize: (int) maskSize result: (FlutterResult) result{
    ...
    result(distanceTransform(data, distanceType, maskSize));
    
}


FlutterStandardTypedData * distanceTransform(FlutterStandardTypedData * data, int distanceType, int maskSize) {
