...
+ (void)process:(FlutterStandardTypedData *)data diameter:(int)diameter sigmaColor:(double)sigmaColor sigmaSpace:(double)sigmaSpace borderType:(int)borderType result:(FlutterResult)result{
    ...
    result(bilateralFilter(data, diameter, sigmaColor, sigmaSpace, borderType));
    
}

FlutterStandardTypedData * bilateralFilter(FlutterStandardTypedData * data, int diameter, double sigmaColor, double sigmaSpace, int borderType){
